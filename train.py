...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='officehome', help='options: cifar10, cifar100, imagenet_100, cub, scars, fgvc_aricraft, herbarium_19, officehome')
